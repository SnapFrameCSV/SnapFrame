...
> **Preview build.** Version 0.0.1 has the free capture, preview and PNG export working and every Pro feature built behind the licence check; no keys can be issued yet and Buy Pro tells you it is not available. Watch the [changelog](CHANGELOG.md).
